	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		 ...
		 return http
		         ...
		         .and()  
		             ...
		             .antMatchers("/member/regist", "/member/update", "/member/updaterole", "/member/updateRequest").hasRole("HR")
		             .antMatchers("/education/photoRegist", "/education/classRegist").hasRole("SAFETY")
				 	 .antMatchers("/skylift/equipment/regist","/skylift/equipment/modify","/skylift/equipment/delete").hasRole("FACILITY")
				 	 .antMatchers("/salary/regist" , "/salary/regist").hasRole("PAYROLL")
				     .antMatchers("skylift/notice/regist", "skylift/notice/modify" , "skylift/notice/delete").hasRole("")
			     .and()
		             .logout()
